...
DELETE FROM BLOCK_SECTION;
INSERT INTO BLOCK_SECTION (BSEC_CODE, BSEC_NAME, BSEC_STATUS, PROG_CODE, AY_CODE, SEM_ID)
VALUES 
('BSIT-1A-2025', 'BSIT 1A', TRUE, 'BSIT', '2025-2026', 2),
('BSIT-1B-2025', 'BSIT 1B', TRUE, 'BSIT', '2025-2026', 2),
('BSIS-1A-2025', 'BSIS 1A', TRUE, 'BSIS', '2025-2026', 2),
('BSIS-1B-2025', 'BSIS 1B', TRUE, 'BSIS', '2025-2026', 2);
